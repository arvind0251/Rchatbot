...
from RADHIKA import RADHIKA, mongo, LOGGER, db
from RADHIKA.modules.helpers import chatai, storeai, languages, CHATBOT_ON
...
@RADHIKA.on_message(filters.command("status"))
...
@RADHIKA.on_message(filters.command(["lang", "language", "setlang"]))
...
@RADHIKA.on_message(filters.command(["resetlang", "nolang"]))
...
@RADHIKA.on_message(filters.command("chatbot"))
