...
HELP_READ = f"""**__❍ ᴄᴏᴍᴍᴀɴᴅs ғᴏʀ {BOT_NAME}__**/n**❍ ᴜsᴇ ||/chatbot [on/off]|| ᴇɴᴀʙʟᴇ/ᴅɪsᴀʙʟᴇ ᴛʜᴇ ᴄʜᴀᴛʙᴏᴛ.**/n❍ ɴᴏᴛᴇ ᴛʜᴇ ᴀʙᴏᴠᴇ ᴄᴏᴍᴍᴀɴᴅ ғᴏʀ ᴄʜᴀᴛʙᴏᴛ ᴡᴏʀᴋ ɪɴ ɢʀᴏᴜᴘ ᴏɴʟʏ!!/n**───────────────**/n❍ Bʏ:- ||__**[˹ ʙᴀʙʏ-ᴍᴜsɪᴄ ™˼𓅂](https://t.me/BABY09_WORLD)**__||"""
HELP_BACK = [
